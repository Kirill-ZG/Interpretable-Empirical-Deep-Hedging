...
from empirical_deep_hedging.include.network import Actor, Critic
from empirical_deep_hedging.include import utility
...
class ActorCritic(object):
    ...
    def save(self, filename):
        path = utility.model_output_path(Path(filename).name + "_actor")
        torch.save(self.actor.state_dict(), path)

    def load(self, filename):
        path = utility.model_artifact_path(Path(filename).name + "_actor")
